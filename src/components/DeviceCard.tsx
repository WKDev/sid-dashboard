...
const DeviceCard = ({ title, uuid, interaction }: CardProps) => {
  ...
  const preloadSrcList: string[] = [
    process.env.REACT_APP_S3_BASE_PATH + uuid + process.env.REACT_APP_S3_SUB_PATH + '/cam1.jpg',
    process.env.REACT_APP_S3_BASE_PATH + uuid + process.env.REACT_APP_S3_SUB_PATH + '/cam2.jpg'
  ]
